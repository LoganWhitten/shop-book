...
const categoryColors = {
  incandescent:
    "from-amber-900/80 to-amber-950/80 text-amber-400 border-amber-800/50",
  led: "from-blue-900/80 to-blue-950/80 text-blue-400 border-blue-800/50",
  moving:
    "from-purple-900/80 to-purple-950/80 text-purple-400 border-purple-800/50",
    ...
    <div className="flex h-screen bg-black text-white overflow-hidden">
      ...
      >
        <div className="p-4 border-b border-gray-800">
          ...
          <h1 className="text-xl font-bold md:hidden">SB</h1>
        </div>
        ...
        <div className="p-2 md:p-4">
          ...
          <div className="space-y-2">
            <div className="text-xs uppercase text-gray-500 font-medium tracking-wider hidden md:block">
              Categories
            </div>
                ...
                Object.entries(groupedProducts).length > 0 ? (
                      ...
                      ([category, categoryProducts]) => (
                        <div key={category}>
                          <div className="flex items-center gap-2 mb-4">
                            <div
                              className={`p-1.5 rounded-full bg-gradient-to-br ${
                                categoryColors[
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-gray-400 max-w-md">
                      We couldn't find any equipment matching your search. Try
            ...
            >
              ...
              <motion.div
                ...
                className={`p-6 bg-gradient-to-r ${
                  categoryColors[
                    currentProduct.categorySlug as keyof typeof categoryColors
                  ]
                } sticky top-0 z-10`}
              >
                      ...
                      <div className="flex flex-wrap gap-2">
                        {currentProduct.lampOptions.map((wattage) => (
                          <button
                            key={wattage}
                            onClick={() =>
                              handleLampChange(currentProduct.id, wattage)
                            }
                            className={cn(
                                ...
                                <div className="text-3xl font-bold">
                                  <AnimatedNumber
                                    value={Number.parseFloat(
                                      calculateAmperage(currentWattage, voltage)
                                    )}
                                    decimals={2}
                                    suffix="A"
                                  />
                      ...
                      <AnimatePresence mode="wait">
                        ...
                        {selectedTab === "docs" && (
                          <motion.div
                            ...
                            transition={{ duration: 0.2 }}
                          >
                            {currentProduct.links &&
                            currentProduct.links.length > 0 ? (
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
...
function ProductCard({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className={`rounded-xl overflow-hidden border border-gray-800 bg-gradient-to-br ${
        categoryColors[product.categorySlug as keyof typeof categoryColors]
      } cursor-pointer`}
      onClick={onClick}
    >
      <div className="p-6 flex flex-col items-center text-center">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {product.voltage &&
            product.categorySlug != "power" &&
            product.categorySlug != "control" && (
              <span className="px-2 py-1 rounded-full bg-black/30 text-xs">
                {product.voltage}V
              </span>
            )}
